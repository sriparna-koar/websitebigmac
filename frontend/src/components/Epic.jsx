...
import epc1 from '../assets/epc1.jpeg';
import { Link } from 'react-router-dom'; // Corrected import for Link

function Epic() {
  return (
    <div className="epc-App">
      <Dots />
      <header className="epc-App-header">
        <div className="epc-header-image">
          <img src={epc} alt="Header" />
        </div>
        <div className="epc-header-content">
          <div className="epc-header-image-small">
            <img src={epc1} alt="Design" />
          </div>
          <div className="epc-header-text">
      ...
      <section className="epc-process">
        ...
        <div className="epc-process-steps">
          <div className="epc-process-step">
            <h3>Consultation</h3>
      ...
      <hr className="line" />
      <section className="epc-portfolio">
        <h2>Our Work</h2>
        <div className="epc-portfolio-gallery">
